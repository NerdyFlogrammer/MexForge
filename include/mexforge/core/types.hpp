...
template<typename T, typename = void> struct is_mex_struct : std::false_type {};

template<typename T> inline constexpr bool is_mex_struct_v = is_mex_struct<T>::value;
